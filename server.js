...
// Minimal Express server to proxy Marketplace API requests securely
// Prevents exposing credentials in the browser and allows us to normalize responses.
...
// Serve static site from this directory for convenience (optional)
app.use(express.static(path.join(__dirname)));

// Helper: build auth header flexibly
